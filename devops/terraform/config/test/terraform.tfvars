...
container_image = "345192829828.dkr.ecr.us-east-1.amazonaws.com/test-divesh-api"
service_name = "divesh-api"
dashboard_name = "test-divesh-api-dashboard"
...
#  {"name":"INSTANA_TAGS","value":"ais=COMP-747,domain=test,service=divesh-api-test"}, 
#  {"name":"INSTANA_DISABLE_MEMORY_CHECK","value":"TRUE"}, 
#  {"name":"INSTANA_SERVICE_NAME","value":"divesh-api-test"}
...
shared-resource-data-config = {
  bucket         = "test-prv-divesh-platform-terraform-state"
  key            = "platform/divesh-platform_terraform_shared.tfstate"
  region         = "us-east-1"
  dynamodb_table = "test-prv-divesh-platform-terraform-lock"
}
